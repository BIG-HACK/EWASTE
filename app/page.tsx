          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start pt-8">
              <Button
                asChild
                size="lg"
                className="text-lg px-12 py-7 h-auto rounded-full bg-emerald-600 hover:bg-emerald-700 shadow-lg hover:shadow-xl transition-all w-80"
              >
                <Link href="/dashboard">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="text-lg px-12 py-7 h-auto rounded-full border-2 shadow-lg hover:shadow-xl transition-all w-80 bg-tertiary"
              >
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            A simple platform connecting those who want to donate with
            organizations ready to collect
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <Card className="border-2 hover:border-primary transition-colors">
            <CardHeader>
              ...
              <CardDescription>
                Easily create listings for your unwanted electronic devices with
                photos and details
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="border-2 hover:border-primary transition-colors">
            <CardHeader>
              ...
              <CardDescription>
                We coordinate with NGOs to collect your e-waste and repair and
                repurpose it.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="border-2 hover:border-primary transition-colors">
            <CardHeader>
              ...
              <CardDescription>
                Electronics get a second life, reducing waste and helping
                communities
              </CardDescription>
            </CardHeader>
          </Card>
        ...
        <p className="text-center mt-6 text-sm text-muted-foreground">
          <Link
            href="/demo/journey-map"
            className="underline hover:text-foreground"
          >
            Preview: Student volunteer journey map
          </Link>
        </p>
      </section>
            ...
            <CardContent className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Keep electronics out of landfills and reduce environmental
                    impact
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold mb-1">
                    Donations at your doorstep
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    Our volunteers will collect your e-waste at your chosen
                    location.
                  </p>
                </div>
              </div>
        ...
        <Card className="bg-primary/5 border-2 border-primary/20">
          <CardContent className="text-center py-16 px-4">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Every device you donate helps reduce waste, save CO₂, and support
              communities in need
            </p>
            <Button
              asChild
              size="lg"
              className="text-xl px-12 py-7 h-auto rounded-full bg-emerald-600 hover:bg-emerald-700 shadow-lg hover:shadow-xl transition-all w-96"
            >
              <Link href="/dashboard">
                Start Your Green Impact
